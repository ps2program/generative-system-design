...
class Component:
    def __init__(self, name, description=None):
        ...
        self.functions = []  # List of functions associated with this component
        self.physicals = []  # List of physicals associated with this component
...
class Function:
    def __init__(self, data, component):
        ...
        if component:
            component.functions.append(self)  # Add this function to the component's function list
...
class Physical:
    def __init__(self, data, component):
        ...
        if component:
            component.physicals.append(self)  # Add this physical to the component's physical list
...
class StateMemory:
    ...
    def add_function(self, data):
        function = Function(data,self.system)
        self.functions[function.id] = function
        return function

    # Add a new physical
    def add_physical(self, data):
        physical = Physical(data, self.system)
    ...
    def get_all_components(self):
        ...
        for component in self.components.values():
            component_data = {
                ...
                'functions': [
                    {'id': fun.id, 'data': fun.data} for fun in component.functions
                ],
                'physicals': [
                    {'id': phy.id, 'data': phy.data} for phy in component.physicals
                ],
            }
            result.append(component_data)
        return result
